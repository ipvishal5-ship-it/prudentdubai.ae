...
test('calculator rules and money formulas stay stable', () => {
  ...
  const offPlanMortgage = buyingCosts({ price: 1_000_000, dldBuyerShare: 4, includeAgency: false, financed: true, loanAmount: 500_000, bankFee: 0, valuationFee: 0, propertyStatus: 'off-plan' });
  assert.equal(offPlanMortgage.mortgageTrusteeFee, 5_250);
